...
Description: the Hanoi tower problem using singlylist stack to solve
Usage: make
...
void Move(int n, singlylist_stack *stacks, int stack_from, int stack_to, int stack_extra){
